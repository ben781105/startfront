...
function Features(){
 ...
 const features = [
  ...
  return(
    <section className="dark:text-[#E2E2B6] dark:bg-gradient-to-t from-[#021526] to-[#03346E] h-fit pr-4 pl-4 pt-8 overflow-x-hidden md:pl-20 md:pr-20 pb-10 space-y-2 flex flex-col ">
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4 overflow-x-hidden'>
        {features.map((feature)=>
         <div className='flex w-full lg:p-4 md:pl-6 md:pr-6 h-70 justify-center bg-[#E2E2B6] text-[#021526]  items-center flex-col p-3  text-center transition-colors duration-300 ease-in-out shadow-md rounded-lg ' 
         key={feature.id}
         >
