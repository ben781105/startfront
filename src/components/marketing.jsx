...
function Marketing() {
  ...
  return (
    <section className=' dark:text-[#E2E2B6] dark:bg-gradient-to-t from-[#021526] to-[#03346E] w-full pl-4 pr-4 pt-15 pb-10 md:pl-20 space-y-5 md:pr-20 flex flex-col'>
      <h1 className='text:text-gray-800 self-center relative text-3xl 2xl:text-3xl '>
          SMS Marketing
      ...
      <div className='grid  grid-cols-1 md:grid-cols-2 gap-8 mt-5'>
          ...
          <div className=' 2xl:py-30 2xl:px-30 space-y-2 h-full flex flex-col w-full py-9 px-10 bg-gray-100 textdark:bg-[#E2E2B6] dark:text-[#03346E] shadow-md rounded-lg p-3 self-center'>
            <h1 className=' text-gray-800 dark:text-[e2e2b6] text-2xl 2xl:text-3xl font-semibold'>SMS Marketing Use Cases</h1>
