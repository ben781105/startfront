...
function Marketing() {
  ...
  return (
    <section className='w-full pl-4 pr-4 pt-15 pb-10 md:pl-20 space-y-5 md:pr-20 flex flex-col'>
      ...
      <div className='grid  grid-cols-1 md:grid-cols-2 gap-8 mt-5'>
          ...
          <div className=' 2xl:py-30 2xl:px-30 space-y-2 h-full flex flex-col w-full py-9 px-10 bg-gray-100 shadow-md rounded-lg p-3 self-center'>
