...
function Pricing() {
  ...
  return (
    <section className="bg-[#fffafa] pt-10 dark:text-[#E2E2B6] dark:bg-gradient-to-t from-[#021526] to-[#03346E] h-fit pl-4 space-y-3 pr-4 md:pl-20 md:pr-20   flex flex-col" >
      <h1 className='light:text-gray-800 self-center relative text-3xl '>
          Pricing
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 2xl:px-30 gap-8 2xl:gap-18 mt-8'>
        ...
        {priceCards.map((priceCard)=>
         <div key={priceCard.id} className='flex flex-col pt-8 pb-8 2xl:pb-0 2xl:h-130 bg-gray-100 hover:bg-blue-500  dark:bg-[#E2E2B6] text-[#021526] transition-colors duration-300 ease-in-out dark:hover:bg-[#021526]  hover:text-white hover: shadow-md rounded-lg p-3 pl-8 2xl:px-12 2xl:pt-10'>
